...
const getAllRecipes = () => {
    let allRecipes = [
            {id: 1,
                title: "Pink Squirrel",
                imgSrc: "",
                description: "Description of a Pink Squirrel blah blah lorem ipsum blah blah blah lorem ipsum ipsum",
                ingredients: "fine ingredients",
...
const buildCard = (cardInfo, cardIndex) => {
    ...
    pDescription.innerHTML = cardInfo.description;
    pIngredients.innerHTML = cardInfo.ingredients;
    pInstructions.innerHTML = cardInfo.instructions;
